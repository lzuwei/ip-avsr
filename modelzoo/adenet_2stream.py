...
def create_pretrained_model(s1_ae, s1_lstm,
    ...
    if not use_blstm_substream:
        l_lstm_s1 = create_pretrained_lstm(s1_lstm, 'flstm', l_delta_s1,
                                           l_mask, lstm_size, cell_parameters, gate_parameters,
                                           'f_lstm_s1', use_peepholes)

        l_lstm_s2 = create_pretrained_lstm(s2_lstm, 'flstm', l_delta_s2,
                                           l_mask, lstm_size, cell_parameters, gate_parameters,
                                           'f_lstm_s2', use_peepholes)
    else:
        f_lstm_s1 = create_pretrained_lstm(s1_lstm, 'flstm', l_delta_s1,
                                           l_mask, lstm_size, cell_parameters, gate_parameters,
                                           'f_lstm_s1', use_peepholes)
        b_lstm_s1 = create_pretrained_lstm(s1_lstm, 'blstm', l_delta_s1,
                                           l_mask, lstm_size, cell_parameters, gate_parameters,
                                           'b_lstm_s1', use_peepholes, backwards=True)
        l_lstm_s1 = ElemwiseSumLayer([f_lstm_s1, b_lstm_s1], name='sum_blstm_s1')

        f_lstm_s2 = create_pretrained_lstm(s2_lstm, 'flstm', l_delta_s2,
                                           l_mask, lstm_size, cell_parameters, gate_parameters,
                                           'f_lstm_s2', use_peepholes)
        b_lstm_s2 = create_pretrained_lstm(s2_lstm, 'blstm', l_delta_s2,
                                           l_mask, lstm_size, cell_parameters, gate_parameters,
                                           'b_lstm_s2', use_peepholes, backwards=True)
        l_lstm_s2 = ElemwiseSumLayer([f_lstm_s2, b_lstm_s2], name='sum_blstm_s2')
