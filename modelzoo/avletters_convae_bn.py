...
def create_model(incoming, options):
    ...
    bn2 = BatchNormLayer(dropout0, name='batchnorm2')
    ...
    bn5 = BatchNormLayer(maxpool2d3, name='batchnorm5')
    ...
    bn8 = BatchNormLayer(maxpool2d6, name='batchnorm8')
    ...
    bn11 = BatchNormLayer(reshape9, name='batchnorm11')
    dense10 = DenseLayer(bn11, num_units=dense_mid_size, name='dense7', nonlinearity=scaled_tanh)
    bn12 = BatchNormLayer(dense10, name='batchnorm12')
    bottleneck = DenseLayer(bn12, num_units=encode_size, name='bottleneck', nonlinearity=linear)
