...
def create_model(dbn, input_shape, input_var, mask_shape, mask_var,
    ...
    f_lstm_bn, b_lstm_bn = create_blstm(l_delta, l_mask, lstm_size, cell_parameters, gate_parameters, 'lstm_bn')
    f_lstm_dct, b_lstm_dct = create_blstm(l_dct, l_mask, lstm_size, cell_parameters, gate_parameters, 'lstm_dct')

    # We'll combine the forward and backward layer output by summing.
    # Merge layers take in lists of layers to merge as input.
    l_sum1 = ElemwiseSumLayer([f_lstm_bn, b_lstm_bn, f_lstm_dct, b_lstm_dct], name='sum1')
