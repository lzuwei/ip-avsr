...
def create_model(ae, diff_ae, input_shape, input_var, mask_shape, mask_var,
    ...
    if fusiontype == 'sum':
        l_fuse = ElemwiseSumLayer([l_lstm_raw, l_lstm_dct, l_lstm_diff], name='sum1')
    elif fusiontype == 'adasum':
        l_fuse = AdaptiveElemwiseSumLayer([l_lstm_raw, l_lstm_dct, l_lstm_diff], name='adasum1')
    elif fusiontype == 'concat':
        l_fuse = ConcatLayer([l_lstm_raw, l_lstm_dct, l_lstm_diff], axis=-1, name='concat')

    l_drop_agg = DropoutLayer(l_fuse, name='dropout_agg')
    ...
    l_dropout = DropoutLayer(l_fuse, p=0.4, name='dropout1')
