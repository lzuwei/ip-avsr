...
from modelzoo import adenet_v1, deltanet, adenet_v2, adenet_v3, adenet_v4, adenet_v5
...
def main():
    ...
    config.read('config/trimodal.ini')
    ...
    '''
    network = adenet_v5.create_model(ae, diff_ae, (None, None, 1200), inputs_raw,
                                     (None, None), mask,
                                     (None, None, 90), dct,
